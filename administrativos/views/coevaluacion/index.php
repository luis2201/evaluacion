            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-light" id="coevaluacionModalLabel"><strong>Rúbrica de Evaluación de Desempeño Administrativo - Coevaluación</strong></h5>
                                ...
                                <table class="table-hover table-condensed table-striped table-bordered text-center align-middle" style="font-size: 12px; table-layout: auto; width: 100%;">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="bg-success text-light">Insuficiente (1 puntos)</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            $i = 0;
                                            $resp = Pregunta::findPreguntaAreaCoevaluacion($idarea);
