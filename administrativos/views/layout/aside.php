  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="w-auto max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a id="mnautoevaluacion" class="nav-link text-white" href="autoevaluacion">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">person_outline</i>
            </div>
            <span class="nav-link-text ms-1">Autoevaluación</span>
          </a>
        </li>
        <li class="nav-item">
          <a id="mncoevaluacion" class="nav-link text-white" href="coevaluacion">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">people</i>
            </div>
            <span class="nav-link-text ms-1">Coevaluación</span>
          </a>
        </li>
      </ul>
    </div>
