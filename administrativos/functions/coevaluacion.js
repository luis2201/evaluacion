...
{
    await axios.get('https://evaluacion.itsup.edu.ec/administrativos/coevaluacion/findcoevaluacionadministrativo/' + idcoevaluacion)
    .then(function (res){
       let info = res.data[0];
       console.log(info)
    ...
    $.confirm({
		...
		buttons: {
			continuar: async function () {
				...
				await axios.post('https://evaluacion.itsup.edu.ec/administrativos/coevaluacion/insert/', {
                    idcoevaluacion,
                    indicador1,
                    indicador2,
                    indicador3,
