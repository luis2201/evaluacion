...
document.getElementById("titulo-principal").innerText = "Evaluación Inmediato Superior";
...
{
    await axios.get('https://evaluacion.itsup.edu.ec/autoridades/heteroevaluacion/findheteroevaluaciondocente/' + idheteroevaluacion)
    .then(function (res){
       let info = res.data[0];
    ...
    $.confirm({
		...
		buttons: {
			continuar: async function () {
				...
				await axios.post('https://evaluacion.itsup.edu.ec/autoridades/heteroevaluacion/insertar/', {
                    idheteroevaluacion,
                    indicador1,
                    indicador2,
                    indicador3,
