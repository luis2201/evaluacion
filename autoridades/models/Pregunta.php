<?php 
    ...
    class Pregunta extends DB
    {
        ...
        public static function findPreguntaAreaAdministrativo($idarea)
        {
            $db = new DB();

            $params = [":idarea" => $idarea, ":tipo" => "H"];
            $prepare = $db->prepare("call sp_preguntas_select_area_heteroevaluacion(:idarea, :tipo);");
            $prepare->execute($params);
