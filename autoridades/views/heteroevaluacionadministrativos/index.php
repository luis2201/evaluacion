                ...
                <div class="col-12">
                    <div class="card card-frame">
                        <div class="card-header bg-dark">
                            <h5 class="text-white">Registro de Evaluación a Administratitivos (Inmediato Superior)</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <table class="table table-striped table-hover table-condensed">
                                        ...
                                        <?php 
                                            $i = 1;
                                            foreach($heteroevaluaciones as $row): 
                                                $administrativo = $row->apellidos.' '.$row->nombres;
                                        ?>
                                            <tr>
                                                <td class="text-center"><?php echo $i++; ?></td>
                                                <td><?php echo $administrativo; ?></td>
                                                <td class="text-center">
                                                    <?php if($row->estado){ ?>
                                                        <span class="badge bg-success">EVALUADO</span>
                                                    <?php } else{ ?>
                                                        <a id="<?php echo Main::encryption($row->idheteroevaluacion); ?>" href="javascript:;" class="btn-warning" onclick="evaluar(this.id);"><span class="badge bg-warning">Evaluar</span></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
        ...
        <!-- Modal -->
        <div class="modal fade" id="heteroevaluacionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="evaluacionModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-light" id="heteroevaluacionModalLabel"><strong>Rúbrica de Evaluación de Desempeño Administrativo - Heteroevaluación</strong></h5>
                        ...
                        <div class="card">
                            <div class="card-header bg-secondary" style="height: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <?php                                             
                                            // $resp = Area::findIdAreaAutoridad($_SESSION['idautoridad_eval']); 
                                            
                                            // foreach($resp as $row):
                                                $idarea = 6;
                                                $area = 'Administrativo';
                                        ?>
                                            <label for="area" class="text-light"><strong>Área: </strong><?php echo $area; ?></label>
                                            
                                            <input type="hidden" id="idarea" name="idarea" class="form-control text-light" value="<?php echo Main::encryption($idarea); ?>">
                                        <?php //endforeach; ?>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table-hover table-condensed table-striped table-bordered text-center align-middle" style="font-size: 12px; table-layout: auto; width: 100%;">
                                    <input type="hidden" id="idheteroevaluacion" name="idheteroevaluacion" value="">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php 
                                            $i = 0;
                                            $resp = Pregunta::findPreguntaAreaAdministrativo($idarea);
                                            foreach($resp as $row):
                                                $i++;
                                        ?>
                                        <tr>
                                            ...
                                            <td><input type="radio" id="indicador<?php echo $i; ?>" name="indicador<?php echo $i; ?>" value="1" class="form-radio mt-2"></td>
  ...
  <!-- Site JS -->
  <script src="<?php echo DIR; ?>functions/heteroevaluacionadministrativos.js"></script>
