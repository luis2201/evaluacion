      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a id="mnheteroevaluacion" class="nav-link text-white" href="heteroevaluacion">
            ...
            <span class="nav-link-text ms-1">Heteroevaluación</span>
          </a>
        </li>
        <li class="nav-item">
          <a id="mnheteroevaluacionadministrativos" class="nav-link text-white" href="heteroevaluacionadministrativos">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">settings_accessibility</i>
            </div>
            <span class="nav-link-text ms-1">Heteroevaluación Adminis.</span>
          </a>
        </li>
      </ul>
    </div>
