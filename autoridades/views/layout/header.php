...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo DIR; ?>assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="<?php echo DIR; ?>assets/img/favicon.png">
