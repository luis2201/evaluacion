                ...
                <div class="col-12">
                    <div class="card card-frame">
                        <div class="card-header bg-dark">
                            <h5 class="text-white">Registro de Evaluación Estudiante - Docente</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php } else{ ?>
                                                        <a id="<?php echo Main::encryption($row->idevaluacion); ?>" href="javascript:;" class="btn-warning" onclick="evaluar(this.id);"><span class="badge bg-warning">Evaluar</span></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-light" id="heteroevaluacionModalLabel"><strong>Rúbrica de Evaluación de Desempeño Docente - Heteroevaluación</strong></h5>
                        ...
                        <div class="card">
                            <div class="card-header bg-secondary" style="height: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <?php 
                                            // $resp = Area::findIdAreaAutoridad($_SESSION['idestudiante_eval']); 
                                            // foreach($resp as $row):
                                                $idarea = 4; //$row->idarea;
                                                $area = "Docencia y Tutoría de Acompañamiento"; //$row->area;
                                        ?>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table-hover table-condensed table-striped table-bordered text-center align-middle" style="font-size: 12px; table-layout: auto; width: 100%;">
                                    <input type="hidden" id="idevaluacion" name="idevaluacion" value="">
                                    <thead>
                                        <tr>
  ...
  <!-- Site JS -->
  <script src="<?php echo DIR; ?>functions/heteroevaluacion.js"></script>
