      <div class="container-fluid py-4 text-center">
        <img src="<?php echo DIR ?>assets/img/logo_itsup_2022_redondo.png" alt="itsup" style="width: 40%">
        <img src="<?php echo DIR ?>assets/img/logo_eco_itsup.png" alt="itsup" style="width: 32%">
      </div>
  ...
  <!-- Site JS -->
  <script src="<?php echo DIR; ?>functions/dashboard.js"></script>
