...
document.getElementById("titulo-principal").innerText = "Evaluación Docente";
...
{
    await axios.get('https://evaluacion.itsup.edu.ec/docente/autoevaluacion/findautoevaluaciondocente/' + idautoevaluacion)
    .then(function (res){
       let info = res.data[0];
    ...
    $.confirm({
		...
		buttons: {
			continuar: async function () {
				...
				await axios.post('https://evaluacion.itsup.edu.ec/docente/autoevaluacion/insert/', {
                    idautoevaluacion,
                    indicador1,
                    indicador2,
                    indicador3,
