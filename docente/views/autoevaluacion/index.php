                ...
                <div class="col-12">
                    <div class="card card-frame">
                        <div class="card-header bg-dark">
                            <h5 class="text-white">Registro de Autoevaluación Docente</h5>
                        </div>
                        <div class="card-body">
                        <?php
                            $fechaActual = date('d-m-Y');
                            
                            if($fechaActual<=date('31-10-2023')){                                
                        ?>
                            <div class="row">
                                <div class="col-12">
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-light" id="autoevaluacionModalLabel"><strong>Rúbrica de Evaluación de Desempeño Docente - Autoevaluación</strong></h5>
  ...
  <!-- Site JS -->
  <script src="<?php echo DIR; ?>functions/autoevaluacion.js"></script>
