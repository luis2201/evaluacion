        ...
        <div class="col-12">
          <div class="card card-frame">
            <div class="card-header bg-dark">
                <h5 class="text-white float-start">Docentes registrados en el Sistema</h5>
                    ...
                    <?php foreach($docentes as $row): ?>
                      <tr>
                        ...
                        <td class="text-center">
                            <a href="javascript:;" id="<?php echo Main::encryption($row->iddocente); ?>" onclick="modificar(this.id)" data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="material-icons-round text-warning" title="Modificar">border_color</span>
                            <a href="javascript:;" id="<?php echo Main::encryption($row->iddocente); ?>" onclick="eliminar(this.id)"><span class="material-icons-round text-danger" title="Eliminar">delete</span>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="form" autocomplete="off">
                      <input type="hidden" id="iddocente" name="iddocente" value="<?php echo Main::encryption(0); ?>">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Agregar Docente</h5>
                                ...
                                <select class="form-control" id="idarea" name="idarea">
                                  <?php 
                                    foreach($areas as $row):
                                      if($row->area == 'Docencia y Tutoría de Acompañamiento'){
                                  ?>
  ...
  <!-- Site JS -->
  <script src="<?php echo DIR; ?>functions/docente.js"></script>
