<div class="container-fluid py-4">
        ...
        <div class="col-12">
          <div class="card card-frame">
            <div class="card-header bg-dark">
                <h5 class="text-white float-start">Autoridades registradas en el Sistema</h5>
                    ...
                    <?php foreach($autoridades as $row): ?>
                      <tr>
                        ...
                        <td class="text-center">
                            <a href="javascript:;" id="<?php echo Main::encryption($row->idautoridad); ?>" onclick="modificar(this.id)" data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="material-icons-round text-warning" title="Modificar">border_color</span>
                            <a href="javascript:;" id="<?php echo Main::encryption($row->idautoridad); ?>" onclick="eliminar(this.id)"><span class="material-icons-round text-danger" title="Eliminar">delete</span>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="form" autocomplete="off">
                      <input type="hidden" id="idautoridad" name="idautoridad" value="<?php echo Main::encryption(0); ?>">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Agregar Autoridades</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group input-group-static mb-2">
                                <label for="idarea" class="ms-0">Tipo de Identificación</label>
                                <select class="form-control" id="idarea" name="idarea">
                                  <option value="">-- Seleccione Área --</option>
                                  <?php foreach($areas as $row): 
                                    if($row->area != 'Aula Virtual'){
                                  ?>
  ...
  <script src="<?php echo DIR; ?>functions/autoridades.js?v=1.0.1"></script>
