        ...
        <div class="col-12">
          <div class="card card-frame">
            <div class="card-header bg-dark">
              <h5 class="text-white">Registro de Administrativo Evaluador</h5>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-10">
                    ...
                    <select class="form-control" id="idevaluador" name="idevaluador">
                        <option value="">-- Seleccione Administrativo Evaluador --</option>
                        <?php foreach($administrativos as $row): ?>
                        <option value="<?php echo Main::encryption($row->idadministrativo); ?>"><?php echo $row->apellidos.' '.$row->nombres; ?></option>
                        <?php endforeach; ?>
                    </select>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table id="tbListaAdministrativo" class="table table-striped table-hover table-condensed table-responsive table-bordered">
                            <thead>
                                <tr class="text-center">
                                    <th class="w-100">NÓMINA DE ADMINISTRATIVOS A EVALUAR</th>
                                    <th></th>
  ...
  <script src="<?php echo DIR; ?>functions/coevaluacion-administrativo.js?v=1.0.5"></script>
