...
cmbIdEvaluador.addEventListener("change", async function(event){
    ...
    await axios.get('https://evaluacion.itsup.edu.ec/admin/coevaluacion/selectevaluadordocente/' + idevaluador)
    .then(function (res) {
        let rows = res.data;
...
function lista()
{
    ...
    if(idevaluador==''){
        $.alert({ 
            ...
            content	: 'Seleccione un Docente Evaluador',
            type	: 'orange',
            theme	: 'modern'				
        });
    ...
    $.confirm({
		...
		buttons: {
			continuar: async function () {
				await axios.post('https://evaluacion.itsup.edu.ec/admin/coevaluacion/insert/', {
					idevaluador,
					iddocente
				})
				.then(function (res) {
...
async function eliminar(idcoevaluacion)
{
    let idevaluador = document.getElementById("idevaluador").value;
    ...
    $.confirm({
		...
		buttons: {
			continuar: async function () {
				await axios.post('https://evaluacion.itsup.edu.ec/admin/coevaluacion/delete/', {
                    idevaluador,
                    idcoevaluacion
                })
				.then(function (res) {
