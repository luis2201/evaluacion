...
var mndashboard = document.getElementById('mnestudiantedocente');
mndashboard.classList.add("active", "bg-gradient-primary");

cargaMateria();

const profesorModal = new bootstrap.Modal('#profesorModal', {
    keyboard: false
})
...
cmbIdCarrera.addEventListener("change", function(){
	
});

var cmbIdSemestre = document.getElementById("idsemestre");
cmbIdSemestre.addEventListener("change", function(){

});

var cmbJornada = document.getElementById("jornada");
cmbJornada.addEventListener("change", function(){

});

async function registrar(idsilabo)
{	
    ...
    await axios.post('https://evaluacion.itsup.edu.ec/admin/estudiantedocente/register/', {
		idsilabo,
        idcarrera,
        idsemestre,
        jornada
...
console.log(info)
		$.alert({
			...
			content: 'Asignación del docente satisfactoria.',
			type: 'blue',
			theme: 'modern',
			buttons: {
				aceptar: function () {
...
async function cargaMateria()
{
	await axios.post('https://evaluacion.itsup.edu.ec/admin/estudiantedocente/finddocenteidsemestre/')
	.then(function (res){
		let info = res.data;		
...
function validate()
{
    ...
    if(document.getElementById("idsemestre").value==""){
        flag = false;
    }
